...
const SideMenubar = () => {
  return (
    <>
        <div className="sidebar-container hidden lg:flex flex-col w-[250px] h-screen bg-zinc-300 px-4 fixed mt-[64.8px] ">
            <div className='flex justify-center mb-5 items-center cursor-pointer mt-5 px-5 py-2 bg-black/80 text-white shadow-md shadow-black/7 rounded-md'>
                ...
                <div className='flex justify-center items-center cursor-pointer w-full px-2 py-2 bg-black/40 text-white shadow-md shadow-black/7 rounded-md'>
                    <p>Previous chats</p>
                </div>
                <div className='flex justify-center items-center cursor-pointer w-full px-2 py-2 bg-black/40 text-white shadow-md shadow-black/7 rounded-md'>
                    <p>Previous chats</p>
